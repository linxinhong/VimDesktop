...
;=======================================================
	...
	Ver    := "0.12.25"
	Dest   := "(ViATc)用于TC的插件"
	vim.PluginInfo("totalcommander",Author,Dest,Ver)
	Global PluginAuthor
	...
	If Not FileExist(TCPath)
	{
		IfWinExist ahk_class TTOTAL_CMD
		{
			...
			IniWrite,%TCPath%,%A_ScriptDir%\plugins\totalcommander\totalcommander.ini,config,TCPath
		}
		Else
		{
	...
	If tciniobj.GetKeyValue("config","ShowComment")
		vim.SetComment("TTOTAL_CMD")
	Else
		IniWrite,0,%A_ScriptDir%\plugins\totalcommander\totalcommander.ini,config,ShowComment
	...
	vim.modeIcon("insert",A_ScriptDir "\plugins\totalcommander\insert.ico","","TTOTAL_CMD")
	vim.SetTimeOut(800,"TTOTAL_CMD")
    vim.map("<esc>","<Normal_Mode_TC>","TTOTAL_CMD")
	vim.mode("Search","TTOTAL_CMD")
	vim.modeIcon("Search",A_ScriptDir "\plugins\totalcommander\Search.ico","","TTOTAL_CMD")
    vim.map("<esc>","<Normal_Mode_TC>","TTOTAL_CMD")
	vim.mode("normal","TTOTAL_CMD")
    vim.map("<esc>","<Esc>","TTOTAL_CMD")
	vim.modeIcon("normal",A_ScriptDir "\plugins\totalcommander\normal.ico","","TTOTAL_CMD")
	...
	vim.map("gggg","<em_gogogo>","TTOTAL_CMD")
...
<em_gogogo>:
	controlSend,Edit1,em_gogogo,ahk_class TTOTAL_CMD
...
azHistory2()
{
	...
	Loop,%max%
	{
		...
		Menu,az,icon,%name%,%A_ScriptDir%\plugins\totalcommander\a-zhistory.icl,%A_Index%,16
	}
